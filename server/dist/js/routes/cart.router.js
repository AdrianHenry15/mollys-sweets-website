...
exports.cartRouter.get("/", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const games = (yield database_service_1.collections
            .carts.find({})
            .toArray());
...
exports.cartRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const game = (yield database_service_1.collections.carts.findOne(query));
        if (game) {
...
exports.cartRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield database_service_1.collections.carts.insertOne(newGame);
        result
            ? res
                .status(201)
