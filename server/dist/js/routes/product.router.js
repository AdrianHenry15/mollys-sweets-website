...
// GET
exports.productRouter.get("/", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const products = (yield database_service_1.collections
            .products.find({})
            .toArray());
...
exports.productRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const product = (yield database_service_1.collections.products.findOne(query));
        if (product) {
...
exports.productRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield database_service_1.collections.products.insertOne(newProduct);
        result
            ? res
                .status(201)
                .send(`Successfully created a new product with id ${result.insertedId}`)
...
exports.productRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield database_service_1.collections.products.updateOne(query, {
            $set: updatedProduct,
        });
        result
...
exports.productRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield database_service_1.collections.products.deleteOne(query);
