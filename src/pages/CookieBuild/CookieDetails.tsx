    ...
    return (
        <section className="cookie-d-container">
            ...
            <div className="cookie-d-make-container">
                <h5 className="cookie-d-title">What Are These Cookies For?</h5>
                <form action="">
                    <select
            ...
            >
                <h5 className="cookie-d-title">Who Are These Cookies For?</h5>
                ...
                <div className="cookie-d-textbox-container">
                    <form action="">
                        ...
                        <aside>
                            ...
                            of a cookie design that you would like to copy for
                            your cookies. <br />
