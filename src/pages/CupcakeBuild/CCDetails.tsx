...
const CCDetails = (props: ICCDetailsProps) => {
    return (
        <Observer>
            {() => {
                return (
                            ...
                            <div className="ccd-textbox-container">
                                <form action="">
                                    ...
                                    <aside>
                                        ...
                                        of a cupcake design that you would like
                                        to copy for your cupcakes. <br />
